...
import (
	...
	domain "github.com/Mitsui515/gorder/order/domain/order"
...
// Create creates a new order in the memory store and returns the created order.
...
// Get retrieves an order from the memory store by its ID and customer ID.
...
// Update updates an order in the memory store and returns the updated order.
